...
from .views import DoctorDashboardView, PatientDashboardView, DoctorListView, DoctorDetailView, BookAppointmentView, RegisterDoctorView, RegisterPatientView, AddPrescriptionView, DownloadPrescriptionView, RateAppointmentView, LoginView, LogoutView,UpdateAppointmentStatusView
